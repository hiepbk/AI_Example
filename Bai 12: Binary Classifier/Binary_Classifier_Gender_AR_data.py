...
# -*- coding: utf-8 -*-
"""
Created on Tue May 18 12:32:26 2021
...
#%%
np.random.seed(1)
path = './AR_datasets/' # path to the database 
...
#     plt.show()
    ...
    # load an img 
fn1 = path + 'M-010-01.bmp'
fn2 = path + 'W-044-01.bmp'
fn3 = path + 'M-044-01.bmp'
fn4 = path + 'W-024-02.bmp'
display_result(fn1)
display_result(fn2)
display_result(fn3)
display_result(fn4)